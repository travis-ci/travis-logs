  ...
  module Logs
    class Config < Travis::Config
      define(
        ...
        logs_database: { url: "postgres://localhost:5432/travis_logs_#{Travis.env}", adapter: 'postgresql', database: "travis_logs_#{Travis.env}", encoding: 'unicode', min_messages: 'warning' },
